  ...
  return (
    <div className={styles.container}>
      <div className={styles.container2}>
        <H1 upper="R" text="eservation" span="span1" />
        <p className={styles.p1}>ご予約については、公式LINE・HOTPEPER Beauty<br></br>
          または、お電話より承っております。</p>
        <div className={styles.container3}>
          <div className={styles.container5}>
            ...
            <p className={styles.p2}>公式LINEで予約する </p >
          </div>
          <div className={styles.container6}>
            ...
            <p className={styles.p3}>HOTPEPERで予約する </p>
          </div>
          <div className={styles.container8}>
            <p className={styles.number}>03-6805-3988</p>
            <p className={styles.phone}>電話で予約する </p>
          </div>
        </div>
        <p className={styles.p4}>公式LINEからのご予約をおすすめしております。 お電話でのご予約について、少人数体制のため接客中は電話に出られない場合がございます。ご了承ください。</p>
        <div className={styles.container9} onClick={reservation_switch_func}>
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#107a7f"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M20.7457 3.32851C20.3552 2.93798 19.722 2.93798 19.3315 3.32851L12.0371 10.6229L4.74275 3.32851C4.35223 2.93798 3.71906 2.93798 3.32854 3.32851C2.93801 3.71903 2.93801 4.3522 3.32854 4.74272L10.6229 12.0371L3.32856 19.3314C2.93803 19.722 2.93803 20.3551 3.32856 20.7457C3.71908 21.1362 4.35225 21.1362 4.74277 20.7457L12.0371 13.4513L19.3315 20.7457C19.722 21.1362 20.3552 21.1362 20.7457 20.7457C21.1362 20.3551 21.1362 19.722 20.7457 19.3315L13.4513 12.0371L20.7457 4.74272C21.1362 4.3522 21.1362 3.71903 20.7457 3.32851Z" fill="#107a7f"></path> </g></svg>
        </div>
      </div>
    </div >
  )
